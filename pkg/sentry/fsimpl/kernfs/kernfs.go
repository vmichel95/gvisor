...
type Filesystem struct {
	...
	// retained by kernfs. If not set, defaults to 0 and kernfs does not cache
	// any dentries.
...
type Dentry struct {
	...
	// been destroyed. Unlike the ref count semantics for other filesystems,
	// refs are allowed to go to 0 and increase again. refs is accessed using
...
// cacheLocked should be called after d's reference count becomes 0.
//
