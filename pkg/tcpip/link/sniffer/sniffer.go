...
// NewWithPrefix creates a new sniffer link-layer endpoint. It wraps around another
// endpoint and logs packets prefixed with logPrefix and they traverse the endpoint.
...
func (e *endpoint) dumpPacket(dir direction, gso *stack.GSO, protocol tcpip.NetworkProtocolNumber, pkt *stack.PacketBuffer) {
	...
	if writer == nil && atomic.LoadUint32(&LogPackets) == 1 {
		logPacket(prefix, dir, protocol, pkt, gso)
	}
